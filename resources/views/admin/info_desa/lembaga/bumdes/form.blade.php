                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Badan Usaha Milik Desa</h4>
                                <ol class="breadcrumb">
                                    <li>
                                    ...
                                    <li>
                                    <a href="{{ route('lembaga.bumdes') }}">Bumdes</a>
                                    </li>
                                    <li class="active">
                                        Input Data 
                                    </li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        Masukkan Data Anggota Bumdes </p>
                                     ...
                                     <div id="formX">
                                        <a id="link" href="{{ route('lembaga.bumdes') }}" style="display: none"></a>
                                        {!! Form::model($model, [
                                        ...
                                        <input type="hidden" name="role" value="bumdes">
                                     {!! Form::close() !!} <br>

                                        <div class="row text-center">
                                            <button type="button" title="Data Anggota Bumdes" class="btn btn-default waves-effect waves-light btn-sm" id="simpanX"> <i class="fa fa-send-o"></i> <span>Submit</span> </button>
