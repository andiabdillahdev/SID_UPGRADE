                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Karang Taruna</h4>
                                <ol class="breadcrumb">
                                    <li>
                                    ...
                                    <li>
                                    <a href="{{ route('lembaga.karangtaruna') }}">Karang Taruna</a>
                                    </li>
                                    <li class="active">
                                        Input Data 
                                    </li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                        Masukkan Data Anggota Karang Taruna </p>
                                     ...
                                     <div id="formX">
                                        <a id="link" href="{{ route('lembaga.karangtaruna') }}" style="display: none"></a>
                                        {!! Form::model($model, [
                                        ...
                                        <input type="hidden" name="role" value="karang">
                                     {!! Form::close() !!} <br>

                                        <div class="row text-center">
                                            <button type="button" title="Data Anggota Karang Taruna" class="btn btn-default waves-effect waves-light btn-sm" id="simpanX"> <i class="fa fa-send-o"></i> <span>Submit</span> </button>
