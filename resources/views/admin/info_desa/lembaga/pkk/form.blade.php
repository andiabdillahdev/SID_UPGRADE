                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                    <a href="{{ route('lembaga.pkk') }}">PKK</a>
                                    </li>
                                    <li class="active">
                                        Input Data 
                                    </li>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <p class="text-muted font-13 m-b-30">
                                     ...
                                     <div id="formX">
                                        <a id="link" href="{{ route('lembaga.pkk') }}" style="display: none"></a>
                                        {!! Form::model($model, [
                                        ...
                                        <input type="hidden" name="role" value="pkk">

                                     {!! Form::close() !!} <br>

                                        <div class="row text-center">
                                            <button type="button" title="Data Anggota PKK" class="btn btn-default waves-effect waves-light btn-sm" id="simpanX"> <i class="fa fa-send-o"></i> <span>Submit</span> </button>
                                        <a href="{{ route('lembaga.pkk') }}" role="button" class="btn btn-danger waves-effect waves-light btn-sm">  <i class="fa fa-ban"></i> <span>Cancel</span> </a>
                                        </div>
