{!! Form::model($model, [
    'route'=> $model->exists ? ['suratkeluar.update',$model->id] : 'suratkeluar.store',
...
<div class="container">
    ...
    <div class="form-group">
        <label class="col-md-3 control-label">Ditujukan <span style="color:red">*</span> </label>
        <div class="col-md-9">
            {!! Form::text('ditujukan',null, ['class'=>'form-control','placeholder'=>'Masukkan Tujuan Surat','id'=>'ditujukan']) !!}
        </div>
    </div>
